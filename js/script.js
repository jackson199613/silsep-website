...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const dictionary = {
        'en': {
            ...
            'nav_swine': 'Swine',
            'nav_poultry': 'Poultry',
            'nav_aquaculture': 'Aquaculture',
            'nav_ruminants': 'Ruminants',
        ...
        'vn': {
            ...
            'nav_swine': 'Heo',
            'nav_poultry': 'Gia cầm',
            'nav_aquaculture': 'Thủy sản',
            'nav_ruminants': 'Gia súc nhai lại',
        ...
        'th': {
            ...
            'nav_swine': 'สุกร',
            'nav_poultry': 'สัตว์ปีก',
            'nav_aquaculture': 'การเพาะเลี้ยงสัตว์น้ำ',
            'nav_ruminants': 'สัตว์เคี้ยวเอื้อง',
